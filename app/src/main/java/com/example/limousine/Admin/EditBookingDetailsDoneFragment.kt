...
import com.example.limousine.databinding.FragmentEditBookingDetailsDoneBinding
...
class EditBookingDetailsDoneFragment : Fragment() {
    private var _binding: FragmentEditBookingDetailsDoneBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentEditBookingDetailsDoneBinding.inflate(inflater, container, false)
            ...
            ref.updateChildren(hashMap)
                .addOnCompleteListener { task ->
                    if (task.isSuccessful) {
                        findNavController().navigate(R.id.action_nav_editBookingDetailsDone_to_nav_home_admin)
