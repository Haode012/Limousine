...
class ChatAdapterAdmin(
    private val chatModelArrayList: ArrayList<ChatModel>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            ...
            MESSAGE_TYPE_LEFT -> {
                val binding2 = ChatItemLeftBinding.inflate(inflater, parent, false)
                MyViewHolderText(binding2.root, null, binding2, parent.context, chatModelArrayList)
            }
            MESSAGE_TYPE_RIGHT_IMAGE -> {
                val binding = ChatItemImageRightBinding.inflate(inflater, parent, false)
                MyViewHolderImage(binding.root, binding, null)
            }
            MESSAGE_TYPE_LEFT_IMAGE -> {
                val binding2 = ChatItemImageLeftBinding.inflate(inflater, parent, false)
                MyViewHolderImage(binding2.root, null, binding2)
            }
            MESSAGE_TYPE_LEFT_AUDIO -> {
                val binding2 = ChatItemAudioLeftBinding.inflate(inflater, parent, false)
                MyViewHolderAudio(binding2.root, null, binding2)
            }
            MESSAGE_TYPE_RIGHT_AUDIO -> {
                val binding2 = ChatItemAudioRightBinding.inflate(inflater, parent, false)
    ...
    class MyViewHolderText(
        itemView: View,
        private val binding: ChatItemRightBinding?,
        private val binding2: ChatItemLeftBinding?,
        private val context: Context,
        ...
        val receiverId: TextView? = binding?.tvReceiverId

        init {
            // Enable text selection for the message TextView
    ...
    inner class MyViewHolderImage(
        itemView: View,
        private val binding: ChatItemImageRightBinding?,
        private val binding2: ChatItemImageLeftBinding?
    ) : RecyclerView.ViewHolder(itemView) {
        ...
        val unread: TextView = binding?.tvUnread ?: binding2!!.tvUnread2
        val frameLayout: FrameLayout = binding?.frameLayout ?: binding2!!.frameLayout
        val receiverId: TextView? = binding?.tvReceiverId2
    }

    inner class MyViewHolderAudio(
        itemView: View,
        private val binding: ChatItemAudioRightBinding?,
        private val binding2: ChatItemAudioLeftBinding?
    ) : RecyclerView.ViewHolder(itemView) {
        ...
        val unread: TextView = binding?.tvUnread ?: binding2!!.tvUnread2
        val frameLayout: FrameLayout = binding?.frameLayout ?: binding2!!.frameLayout
        val receiverId: TextView? = binding?.tvReceiverId3
    }
