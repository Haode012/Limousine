        ...
        if (email.isEmpty()) {
            ...
            auth.signInWithEmailAndPassword(email, password)
                .addOnCompleteListener(requireActivity()) { task ->
                    progressBar.visibility = View.GONE // Hide the progress bar regardless of the outcome
                    ...
                    if (task.isSuccessful) {
                                ...
                                override fun onDataChange(snapshot: DataSnapshot) {
                                    if (snapshot.exists()) {
                                        ...
                                        if (userType == "User") {
                                            ...
                                            auth.signOut()
                                            Toast.makeText(requireContext(), "You are not authorized to log in", Toast.LENGTH_SHORT).show()
                                        }
                                    } else {
                                        // User data not found
                        ...
                        Toast.makeText(requireContext(), "Email or/and Password incorrect", Toast.LENGTH_SHORT).show()
                    }
                }
        }
    }
